      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#services" className="text-gray-300 hover:text-purple-400 transition-colors">Journal</a>
            <a href="#resources" className="text-gray-300 hover:text-purple-400 transition-colors">Mood</a>
            <a href="#contact" className="text-gray-300 hover:text-purple-400 transition-colors">Talk</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 animate-slide-in">
            <nav className="flex flex-col space-y-2">
              <a href="#home" className="bg-blue-900 text-purple-300 font-medium px-4 py-3 rounded-lg transition-colors">
                Home
              </a>
              ...
              <a href="#services" className="bg-yellow-900 text-gray-300 px-4 py-3 rounded-lg transition-colors">
                Journal
              </a>
              <a href="#resources" className="bg-purple-900 text-gray-300 px-4 py-3 rounded-lg transition-colors">
                Mood
              </a>
              <a href="#contact" className="text-gray-300 hover:bg-gray-800 px-4 py-3 rounded-lg transition-colors">
                Talk
              </a>
              <a href="#assessment" className="bg-blue-900 text-purple-300 px-4 py-3 rounded-lg transition-colors">
                Assessment
              </a>
